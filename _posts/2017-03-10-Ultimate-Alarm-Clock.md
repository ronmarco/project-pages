...
The first step is to create an alarm clock interface in Home Assistant. It is used to set the time that the alarm goes off. Once the time is set, you won't have to touch it again.
