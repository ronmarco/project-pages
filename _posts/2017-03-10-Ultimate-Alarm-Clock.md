...
For the scripts, you can adjust timing. For example, adding `- delay: 00:05:00` will delay a service by 5 minutes ([more information here](https://home-assistant.io/docs/scripts/)). 
