...
1. Add more devices to the script
2. For the iterface, you could use Tasker or one of the many <a href="https://home-assistant.io/components/#all" target="_blank">Home Assistant components</a> to set the alarm clock automatically using information from your phone. 
